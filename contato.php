...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <address>
                <strong>Cebolinha Lanches</strong><br>
                Rua Campos Sales<br>
                Rua atrás da Luzia de Paula<br>
                <abbr title="Phone">
                    Telefone:</abbr>
                (12) 3103-6321
            </address>
            <address>
                <strong>Cebolinha Lanches - Cachoeira Paulista</strong><br>
                <a href="mailto:#">contato@cebolinhalanches.com.br</a>
            </address>
            </form>
        </div>
    </div>
